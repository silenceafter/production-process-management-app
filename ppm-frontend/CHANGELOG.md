...
- Создайте проект React с помощью create-vite: `npm init --yes vite@latest production-process-management-app.client -- --template=react  --no-rolldown --no-immediate`.
...
- Создание файла проекта (`production-process-management-app.client.esproj`).
