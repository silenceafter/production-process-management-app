...
import { selectLoading } from '../../store/slices/technologies/technologiesSlice';
...
function MainPage({ page }) {
  ...
  switch (page) {
    ...
    case 'technologies':
      ...
      pageRussian = 'Технологии';
      break;
    case 'planning':
      content = <Planning showLoading={showLoading} />;
      pageRussian = 'Планирование';
      break;
    case 'admin/accounts':
      content = <Accounts />;
      break;
